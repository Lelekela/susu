...
TELEGRAM_BOT_TOKEN = '7292169301:AAGgwC44CNmelbqtE9s1BBlSRRhsc181MJk'
ADMIN_USER_ID = 6200706724
...
async def legacy(update: Update, context: CallbackContext):
    ...
    if len(args) != 2:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /kami <add|rem> <user_id>*", parse_mode='Markdown')
        return
